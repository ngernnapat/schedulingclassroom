...
RUNE_LLM_CATALOG: Dict[str, Dict[str, str]] = {
    ...
    "kenaz": {"name": "Kenaz", "meaning": "Torch — knowledge made visible", "category": "growth", "becoming": "You picked a plan and lit the torch — Practice this step turns each day into reps."},
    ...
    "perthro": {"name": "Perthro", "meaning": "Lot-cup — engaging with chance and choice", "category": "wisdom", "becoming": "You let AI shape a plan and stayed open — step drills and coach reviews deepen the path."},
